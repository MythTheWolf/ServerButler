...
public class about extends CommandAdapter {
    ...
    public void onCommand(Optional<MythPlayer> sender, String[] args, JavaPlugin javaPlugin) {
        ...
        if (sender.isPresent() && sender.get().hasPermission(ConfigProperties.VIEW_PLAYER_IPS_PERMISSION)) {
        ...
        stringList.stream().map(s -> ChatColor.translateAlternateColorCodes('&', s)).forEach(this::reply);
    }
}
