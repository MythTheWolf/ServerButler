 ...
 */
public class ActionUserMute implements ModerationAction, SQLAble {
    /**
     * The target player
     */
     ...
     */
    public ActionUserMute(String id) {
        DB_ID = id;
     ...
     */
    public ActionUserMute(String reason, MythPlayer target, MythPlayer moderator) {
        this.target = target;
